<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas/Cate.master" AutoEventWireup="true" CodeFile="RegistroProducto.aspx.cs" Inherits="Paginas_RegistroProducto" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <table class="nav-justified" id="tblClientes">
        <tr>
            <td colspan="3"><h3>Productos</h3></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td>
            ...
            <td>
                <asp:TextBox ID="txtCc_C" runat="server"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            ...
            <td>
                <asp:TextBox ID="txtNom_C" runat="server"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            ...
            <td>
                <asp:TextBox ID="txtDir_C" runat="server"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            ...
            <td>
                <asp:TextBox ID="txtTel_C" runat="server"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            ...
            <td>
                <asp:TextBox ID="txtCor_C" runat="server"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td>
                <asp:Label ID="Label6" runat="server" Text="Tipo Cliente:"></asp:Label>
            </td>
            <td>
                <asp:TextBox ID="txtTip_C" runat="server"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td>
                <asp:Label ID="Label7" runat="server" Text="Nombre Empresa:"></asp:Label>
            </td>
            <td>
                <asp:TextBox ID="TxtNomEmp_C" runat="server"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        ...
        <tr>
            ...
            <td>&nbsp;</td>
            <td>
                <asp:Button ID="btnAdd_C" runat="server" Text="Agregar" />
            </td>
        </tr>
    </table>
</asp:Content>
