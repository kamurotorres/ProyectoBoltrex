...
<div class="header">
		<div class="container">
			<div class="logo">
				<a href="PaginaCliente.aspx"><span>Bol</span>Trex</a>
			</div>
			<div class="header-right">
			<a class="account" href="Login.aspx">Login</a>
						...
						<div class="signin">
							<div class="signin-rit">
								<span class="checkbox1">
									 <label class="checkbox"><input type="checkbox" name="checkbox" checked="">¿Olvido Su Contraseña?</label>
								</span>
							...
							<div class="log-input">
								<div class="log-input-left">
                                    ...
                                    <asp:TextBox ID="txtUser" runat="server" class="user" value="Your Email" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Your Email';}"></asp:TextBox>
								</div>
							...
							<div class="log-input">
								<div class="log-input-left">
                                    ...
                                    <asp:TextBox ID="txtPass" runat="server" type="password" class="lock" value="password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email address:';}" TextMode="Password"></asp:TextBox>
								</div>
								<span class="checkbox2">
									 <label class="checkbox"><input type="checkbox" name="checkbox" checked=""><i> </i></label>
								</span>
